...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/anonymous_loader/version.rb", mod) }::AnonymousLoader::Version::VERSION
  else
    require_relative "lib/anonymous_loader/version"
    AnonymousLoader::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "anonymous_loader"
  spec.version = gem_version
  spec.authors = ["Peter H. Boling"]
  spec.email = ["floss@galtzo.com"]

  spec.summary = "💎 Load Ruby source files inside anonymous namespaces."
  spec.description = "💎 AnonymousLoader resolves Ruby files from paths, gem metadata, or $LOAD_PATH and evaluates them inside anonymous modules to avoid top-level namespace collisions."
  spec.homepage = "https://github.com/ruby-oauth/anonymous_loader"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://anonymous-loader.galtzo.com"
  ...
  # The 'git' gem is optional; anonymous_loader falls back to shelling out to `git` if it is not present.
