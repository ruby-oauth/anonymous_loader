# kettle-jem:freeze
# To retain chunks of comments & code during anonymous_loader templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# anonymous_loader will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
