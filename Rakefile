...
# anonymous_loader Rakefile v7.1.0 - 2026-08-01
...
# rake install                                # Build and install anonymous_loader-1.0.0.gem in...
# rake install:local                          # Build and install anonymous_loader-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template anonymous_loader against itse...
